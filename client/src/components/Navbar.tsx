      ...
      >
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-8 p-2 bg-orange-50 rounded-full ring
                        ring-app-orange/15 focus-app-orange/30"
              />
            </div>
          </form>
              ...
              {cartCount > 0 && (
                <span
                  className="absolute -top-1 -right-1
                            size-4 bg-app-orange text-white text-[10px]
        ...
        text-white flex-center"
              ...
              {usermenuOpen && (
                ...
                bg-white rounded-xl shadow-lg border border-app-border
